...
def my_sub_dag(parent_dag_id):
    ...
    def my_check_condition(**context):
      ...
      ti = context['ti']
      p_val = ti.xcom_pull(task_ids='push_task',key='the_message', dag_id='dag_simple_xcom')
...
sub_dag = SubDagOperator(
        subdag=my_sub_dag("dag_simple_xcom"),
        task_id='my_sub_dag',
        dag=dag
    )
