...
for level1_item in level1_list:
    level1_dag = create_sub_dag(dag_id, level1_item, datetime(1970, 1, 1), None)
    ...
    for level2_item in level2_list:
        ...
        level2_dag = create_sub_dag(level1_dag_id, level2_item, datetime(1970, 1, 1), None)
